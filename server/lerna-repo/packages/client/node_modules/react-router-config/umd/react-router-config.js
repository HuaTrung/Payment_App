(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react-router/es/matchPath'), require('react-router/es/Router'), require('react'), require('react-router/es/Switch'), require('react-router/es/Route')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react-router/es/matchPath', 'react-router/es/Router', 'react', 'react-router/es/Switch', 'react-router/es/Route'], factory) :
      ...
      routes.map(function (route, i) {
        return React.createElement(Route, {
          ...
          render: function render(props) {
            return route.render ? route.render(Object.assign({}, props, extraProps, { route: route })) : React.createElement(route.component, _extends({}, props, extraProps, { route: route }));
          }
        });
      })
    ) : null;
